...
if (isset($_POST['field_submit'])) {
    ...
    $query = "SELECT * FROM mega_table WHERE registration_state = :ph_registration_state LIMIT 100";
  ...
  <body>
    <div id="navbar">
      <ul>
        ...
        <li><a href="getParkingData.php">Search ParkingData</a></li>
        <li><a href="insertParkingData.php">Insert ParkingData</a></li>
      </ul>
    </div>
    
    <h1> Search ParkingData by Registration state</h1>
    <!-- This is the start of the form. This form has one text field and one button.
      See the project.css file to note how form is stylized.-->
    <form method="post">

      <label for="id_registration_state">registration_state</label>
    ...
    <?php
      if (isset($_POST['field_submit'])) {
        ...
        <?php } else { ?>
          ...
          <h3>Sorry, no results found for registration state <?php echo $_POST['field_registration_state']; ?>. </h3>
          <h3>Sorry, no results found for registration state <?php echo $result; ?>. </h3>
          <h3>Sorry, no results found for registration state <?php echo $prepared_stmt; ?>. </h3>
        <?php }
    } ?>
